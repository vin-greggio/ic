...
coeffs = pywt.swt(retornos_final, 'db4', level=8, trim_approx=True)

fig, axs = plt.subplots(3,3)
fig.suptitle('Decomposição em coeficientes de ondaletas, não dizimada, dos retornos diários Ibovespa, ondaleta db4 ')
